...
public class CarEncoder
{
    ...
    {
        CodecUtil.uint8Put(buffer, offset + 6, value.value());
        return this;
    }
    public CarEncoder code(final Model value)
    {
        CodecUtil.charPut(buffer, offset + 7, value.value());
        return this;
    }
    ...
    public void someNumbers(final int index, final int value)
    {
        ...
        CodecUtil.int32Put(buffer, this.offset + 8 + (index * 4), value, java.nio.ByteOrder.LITTLE_ENDIAN);
    }
    ...
    public void vehicleCode(final int index, final byte value)
    {
        ...
        CodecUtil.charPut(buffer, this.offset + 28 + (index * 1), value);
    }
    ...
    public CarEncoder putVehicleCode(final byte[] src, final int srcOffset)
    {
        ...
        CodecUtil.charsPut(buffer, this.offset + 28, src, srcOffset, length);
        return this;
    }
...
@GroupOrder({PerformanceFiguresEncoder.AccelerationEncoder.class})
    ...
    public void make(final String value)
    {
        final byte[] bytes;
        try
        {
    ...
    public void model(final String value)
    {
        final byte[] bytes;
        try
        {
