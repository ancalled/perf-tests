...
public class MarketDataBenchmark {
    ...
    public static void encode(
        ...
        marketData.wrap(buffer, bufferIndex + messageHeader.size())
                .transactTime(1234L)
                .eventTimeDelta(987)
    ...
    private static void decode(
        ...
        marketData.wrap(buffer, bufferIndex + messageHeader.size(), actingBlockLength, actingVersion);
    ...
    private static void perfTestEncode(final int runNumber) {
        ...
        System.out.printf(
                ...
                state.marketDataEncoder.size() + state.messageHeaderEncoder.size());
    }
    ...
    private static void perfTestDecode(final int runNumber) {
        ...
        System.out.printf(
                ...
                totalDuration / reps,
                benchmark.getClass().getName(),
                state.marketDataDecoder.size() + state.messageHeaderDecoder.size());
    }
}
